      ...
      >
        ...
        <div className="px-5 sm:px-6 py-4 border-b border-zinc-100 flex items-center justify-between bg-white/95 backdrop-blur-md sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 id="payment-guide-title" className="text-base sm:text-lg font-bold text-zinc-900 tracking-tight">
        ...
        <div className="p-2 border-b border-zinc-100 bg-zinc-100/70 grid grid-cols-2 sm:grid-cols-4 gap-1.5">
          <button
            type="button"
        ...
        <div className="px-5 sm:px-6 py-4 overflow-y-auto space-y-4 text-xs leading-relaxed text-zinc-700">
          ...
          {activeTab === "online" && (
            <div className="space-y-3.5">
              ...
              {taxPayableAmount !== undefined && taxPayableAmount > 0 && (
                <div className="p-3.5 bg-zinc-900 text-white rounded-2xl flex items-center justify-between gap-3 shadow-xs">
                  <div>
              ...
              <div className="p-3 bg-zinc-50 border border-zinc-200/80 rounded-2xl text-zinc-600 text-xs flex items-start gap-2.5">
              ...
              {/* Golden Rule */}
              <div className="p-3.5 bg-emerald-50/80 border border-emerald-200/80 rounded-2xl text-emerald-950 text-xs flex items-start gap-2.5 shadow-2xs">
              ...
              {/* Maya App */}
              <div className="p-4 border border-zinc-200/90 rounded-2xl space-y-3 bg-white shadow-2xs hover:border-zinc-300 transition">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5 font-bold text-sm text-zinc-900">
                  ...
                  <span className="text-[10px] bg-emerald-100/70 text-emerald-800 px-2.5 py-0.5 rounded-full font-bold border border-emerald-200/60">
                    {isEn ? "Fastest & Lowest Fees" : "Pinakamabilis & Mababa ang Fee"}
                  </span>
                </div>
                <ol className="list-decimal pl-5 space-y-1.5 text-zinc-600 text-[11px]">
                  <li>
                    {isEn
                ...
                <div className="pt-2 flex flex-wrap items-center justify-between gap-2 border-t border-zinc-100">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-[11px] text-zinc-500 hover:text-zinc-800 font-semibold px-2 py-1"
                  >
                    <span>maya.ph</span>
              ...
              <div className="p-4 border border-zinc-200/90 rounded-2xl space-y-3 bg-white shadow-2xs hover:border-zinc-300 transition">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] bg-zinc-100 text-zinc-600 px-2.5 py-0.5 rounded-full font-semibold border border-zinc-200/60">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="p-3.5 bg-zinc-50/80 rounded-2xl border border-zinc-200/80 space-y-2 flex flex-col justify-between">
                  <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-800 hover:text-emerald-900 pt-1"
                  >
                ...
                <div className="p-3.5 bg-zinc-50/80 rounded-2xl border border-zinc-200/80 space-y-2 flex flex-col justify-between">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-sky-800 hover:text-sky-900 pt-1"
                  >
          ...
          {activeTab === "banks" && (
            <div className="space-y-3.5">
              <div className="p-3.5 bg-indigo-50/80 border border-indigo-200/80 rounded-2xl text-indigo-950 text-xs flex items-start gap-2.5 shadow-2xs">
              ...
              {/* Banks Grid */}
              <div className="p-4 bg-white rounded-2xl border border-zinc-200/90 space-y-2.5 shadow-2xs">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-zinc-900 text-xs">
                    {isEn ? "Major Authorized Agent Banks (AABs):" : "Mga Pangunahing Authorized Agent Banks (AABs):"}
                  </span>
                  <span className="text-[10px] text-zinc-500 font-medium">Over-the-Counter or Online</span>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 text-[11px]">
                  {aabBanks.map((bank) => (
                    <div
                      key={bank.code}
                      className="p-2.5 bg-zinc-50/80 rounded-xl border border-zinc-200/70 flex items-center justify-between hover:bg-zinc-100/80 transition"
                    >
                      <span className="font-semibold text-zinc-800 truncate pr-2">{bank.name}</span>
                      <span className="font-mono text-[10px] font-bold text-zinc-500 bg-white px-1.5 py-0.5 rounded border border-zinc-200 shrink-0">
                        {bank.code}
                      </span>
                    </div>
                  ))}
              ...
              {/* RDO Cashier */}
              <div className="p-4 bg-zinc-50/80 border border-zinc-200/80 rounded-2xl space-y-1.5">
          ...
          {activeTab === "sequence" && (
            <div className="space-y-3.5">
              <div className="p-3.5 bg-sky-50/80 border border-sky-200/80 rounded-2xl text-sky-950 text-xs flex items-start gap-2.5 shadow-2xs">
              ...
              {/* Step 1 */}
              <div className="p-4 bg-white border border-zinc-200/90 rounded-2xl space-y-2 shadow-2xs hover:border-zinc-300 transition">
                ...
                <div className="pl-8 pt-1 flex flex-wrap items-center gap-2">
                  {onOpenEBIRGuide && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-zinc-100 hover:bg-zinc-200 active:scale-95 text-zinc-900 rounded-xl text-xs font-bold transition cursor-pointer border border-zinc-200"
                    >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-zinc-50 active:scale-95 text-zinc-700 rounded-xl text-xs font-semibold transition border border-zinc-200"
                  >
          ...
          {activeTab === "eopt" && (
            <div className="space-y-3.5">
              <div className="p-4 bg-amber-50/80 border border-amber-200/80 rounded-2xl space-y-1.5 text-amber-950 shadow-2xs">
                <div className="font-bold text-xs sm:text-sm flex items-center gap-2 text-amber-900">
              ...
              <div className="space-y-2.5 text-xs">
                <div className="p-3.5 bg-zinc-50/80 border border-zinc-200/80 rounded-2xl flex items-start gap-2.5">
                  <Check className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <div className="space-y-0.5">
                    <strong className="text-zinc-900 text-xs">{isEn ? "File & Pay Anywhere Nationwide:" : "Mag-file at Magbayad Kahit Saan:"}</strong>
                    <p className="text-[11px] text-zinc-600 leading-relaxed">
                      {isEn
                ...
                <div className="p-3.5 bg-zinc-50/80 border border-zinc-200/80 rounded-2xl flex items-start gap-2.5">
                  <Check className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <div className="space-y-0.5">
                    <strong className="text-zinc-900 text-xs">{isEn ? "₱500 Annual Registration Fee Abolished:" : "Wala nang ₱500 Annual Registration Fee:"}</strong>
                    <p className="text-[11px] text-zinc-600 leading-relaxed">
                      {isEn
                ...
                <div className="p-3.5 bg-zinc-50/80 rounded-2xl flex items-start gap-2.5">
                  <Check className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <div className="space-y-0.5">
                    <strong className="text-zinc-900 text-xs">{isEn ? "Micro Taxpayer Classification:" : "Klasipikasyon bilang Micro Taxpayer:"}</strong>
                    <p className="text-[11px] text-zinc-600 leading-relaxed">
                      {isEn

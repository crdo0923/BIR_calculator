    ...
    ? [
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              <p>
              ...
              <div className="p-3 bg-zinc-100/90 dark:bg-zinc-800/90 rounded-xl border border-zinc-200/90 dark:border-zinc-700 font-mono text-[11.5px] font-medium text-zinc-800 dark:text-zinc-200 shadow-2xs">
                Formula: (Gross Earnings − ₱250,000) × 8%
              </div>
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">100% Exempt from Percentage Tax:</strong> You do NOT file BIR Form
                  2551Q every quarter. That saves you 4 tax filings per year.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">No Receipts Needed:</strong> You don&apos;t have to submit or defend
                  expense receipts to reduce your tax.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Simpler Tax Form:</strong> You file BIR Form 1701A instead of the
                  longer Form 1701.
                </li>
              </ul>
            </div>
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Expenses Deductible:</strong> You can deduct business expenses using
                  either <strong className="font-semibold text-zinc-900 dark:text-zinc-100">40% OSD</strong> (an automatic 40% deduction without receipts) or{" "}
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Itemized Deductions</strong> (official BIR receipts).
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">The 3% Percentage Tax:</strong> Unlike the 8% flat rate, Graduated
                  filers must pay an additional <strong className="font-semibold text-zinc-900 dark:text-zinc-100">3% Percentage Tax (Sec. 116)</strong> on gross sales every
                  quarter.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">2 Forms Every Quarter:</strong> You must file both Form 1701Q
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <div className="p-3 rounded-xl border border-zinc-200 dark:border-zinc-700/80 bg-zinc-50 dark:bg-zinc-800/70 space-y-1.5 shadow-2xs">
                  <span className="font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-1.5 text-xs">
                    <Check className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" /> Choose 8% Flat Rate if:
                  </span>
                ...
                <div className="p-3 rounded-xl border border-zinc-200 dark:border-zinc-700/80 bg-zinc-50 dark:bg-zinc-800/70 space-y-1.5 shadow-2xs">
                  <span className="font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-1.5 text-xs">
                    <Check className="w-3.5 h-3.5 text-zinc-600 dark:text-zinc-400" /> Choose Graduated if:
                  </span>
                  <p className="text-zinc-600 dark:text-zinc-300 text-[11px] leading-relaxed">
            ...
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                ...
                <li>
                  ...
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">₱250,000 deduction is not allowed</strong> because it was already
                  applied to your salary.
                </li>
                <li>
                  Sideline formula: <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 font-mono text-[11px] border border-zinc-200/60 dark:border-zinc-700">Freelance Gross × 8%</code>.
                </li>
                <li>
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Gross Income over ₱3,000,000:</strong> Once your gross receipts
                  exceed the ₱3M VAT threshold, 8% is automatically revoked. You must register for VAT and use Graduated
                  rates.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Already VAT-Registered:</strong> If your BIR Certificate of
                  Registration (Form 2303) indicates VAT tax type, you cannot avail of 8%.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Must Signify in Q1:</strong> You must check the 8% option box on your
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  You will receive a <strong className="font-semibold text-zinc-900 dark:text-zinc-100">BIR Certificate of Registration (Form 2303)</strong>.
                </li>
                <li>
                  Under the <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Ease of Paying Taxes (EOPT) Act</strong>, the ₱500 Annual Registration Fee has been
                  permanently removed!
                </li>
                <li>
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Dollar-for-dollar deduction:</strong> If your annual tax due is ₱60,000 and your clients
                  already withheld ₱30,000 via Form 2307, your remaining cash out is only ₱30,000.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Never throw away Form 2307:</strong> Keep the signed copy from your clients, as it serves as
    ...
    : [
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Libre sa Percentage Tax:</strong> HINDI mo na kailangang mag-file ng
                  BIR Form 2551Q bawat quarter. Bawas apat na tax return bawat taon!
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Walang Kailangang Resibo:</strong> Hindi mo kailangang patunayan ang
                  mga gastos mo para mabawasan ang buwis.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Mas Simpleng Form:</strong> BIR Form 1701A lang ang gagamitin mo sa
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">May Bawas sa Gastos:</strong> Pwede mong ibawas ang gastos sa negosyo
                  gamit ang <strong className="font-semibold text-zinc-900 dark:text-zinc-100">40% OSD</strong> (automatic na 40% bawas kahit walang resibo) o{" "}
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Itemized Deductions</strong> (opisyal na BIR resibo).
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">May 3% Percentage Tax:</strong> Hindi tulad ng 8% flat rate, ang
                  Graduated filers ay kailangan pang magbayad ng <strong className="font-semibold text-zinc-900 dark:text-zinc-100">3% Percentage Tax (Sec. 116)</strong> sa gross
                  sales bawat quarter.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">2 Form Bawat Quarter:</strong> Kailangan mong mag-file ng Form 1701Q
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <div className="p-3 rounded-xl border border-zinc-200 dark:border-zinc-700/80 bg-zinc-50 dark:bg-zinc-800/70 space-y-1.5 shadow-2xs">
                  <span className="font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-1.5 text-xs">
                    <Check className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" /> Piliin ang 8% Flat Rate kung:
                  </span>
                  <p className="text-zinc-600 dark:text-zinc-300 text-[11px] leading-relaxed">
                ...
                <div className="p-3 rounded-xl border border-zinc-200 dark:border-zinc-700/80 bg-zinc-50 dark:bg-zinc-800/70 space-y-1.5 shadow-2xs">
                  <span className="font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-1.5 text-xs">
                    <Check className="w-3.5 h-3.5 text-zinc-600 dark:text-zinc-400" /> Piliin ang Graduated kung:
                  </span>
                  <p className="text-zinc-600 dark:text-zinc-300 text-[11px] leading-relaxed">
            ...
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                ...
                <li>
                  ...
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">WALA NANG ₱250,000 na bawas</strong> dahil nagamit na ito sa sweldo mo.
                </li>
                <li>
                  Sideline formula sa 8%: <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 font-mono text-[11px] border border-zinc-200/60 dark:border-zinc-700">Freelance Gross × 8%</code>.
                </li>
                <li>
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Lagpas sa ₱3,000,000 ang Kita:</strong> Kapag lumagpas sa ₱3M ang
                  gross receipts sa taon, awtomatikong bawal ang 8%. Kailangang mag-VAT at mag-Graduated rates.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">VAT-Registered sa BIR:</strong> Kung nakasaad sa iyong COR (Form
                  2303) na VAT ka, hindi ka pwedeng mag-8%.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Hindi Napili sa 1st Quarter:</strong> Kailangang ideklara ang pagpili
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  Makakatanggap ka ng <strong className="font-semibold text-zinc-900 dark:text-zinc-100">BIR Certificate of Registration (Form 2303)</strong>.
                </li>
                <li>
                  Sa ilalim ng <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Ease of Paying Taxes (EOPT) Act</strong>, tinanggal na nang permanente ang ₱500
        ...
        },
        {
          ...
          details: (
            <div className="space-y-3 pt-2 text-zinc-600 dark:text-zinc-300 leading-relaxed text-xs">
              ...
              <ul className="space-y-1.5 pl-4 list-disc text-zinc-600 dark:text-zinc-300 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Bawas piso-sa-piso:</strong> Kung ang kabuuang buwis mo ay ₱60,000 at nakakaltasan ka na ng
                  ₱30,000 via Form 2307, ₱30,000 na lamang ang kailangan mong ilabas na cash sa BIR.
                </li>
                <li>
                  <strong className="font-semibold text-zinc-900 dark:text-zinc-100">Huwag itapon ang Form 2307:</strong> Itago ang kopya mula sa mga kliyente dahil ito ang
          ...
          return (
            <div
              ...
              className={`rounded-xl border transition-all duration-150 ${
                isOpen
                  ? "border-emerald-600/30 dark:border-emerald-500/30 bg-zinc-50/70 dark:bg-zinc-800/60 ring-1 ring-emerald-500/20 shadow-xs"
                  : "border-zinc-200/80 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 bg-white dark:bg-zinc-900/90"
              }`}
            >
              <button
                type="button"
              ...
              >
                <div className="space-y-1 pr-1">
                  <div className="text-xs sm:text-sm font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-2.5">
                    <span className="w-5 h-5 rounded-md bg-zinc-100 dark:bg-zinc-800 border border-zinc-200/80 dark:border-zinc-700/80 text-zinc-700 dark:text-zinc-300 text-[11px] flex items-center justify-center font-bold shrink-0">
                      {idx + 1}
                    </span>
                    <span>{item.question}</span>
                  </div>
                  {!isOpen && (
                    <p className="text-[11px] text-zinc-500 dark:text-zinc-400 pl-7 line-clamp-1">
                      {item.shortAnswer}
                    </p>
                  )}
                </div>
              ...
              {isOpen && (
                <div className="px-3.5 pb-4 sm:px-4 sm:pb-4 border-t border-zinc-200/60 dark:border-zinc-800 text-zinc-600 dark:text-zinc-300">
                  {item.details}
                </div>
              )}
            </div>

  ...
  return (
    <>
      ...
      {isBannerVisible && !showPreferences && (
        <div className="fixed bottom-20 sm:bottom-6 left-3 right-3 sm:left-auto sm:right-6 sm:max-w-md z-40 bg-white border border-zinc-200/90 rounded-2xl shadow-xl p-4 sm:p-5 animate-in fade-in slide-in-from-bottom-4 duration-300">
          <div className="flex items-start gap-3">
            <div className="w-9 h-9 rounded-xl bg-zinc-100 text-zinc-800 flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <div className="space-y-1.5 flex-1 text-xs">
              <div className="flex items-center justify-between">
                ...
                {forceOpen && onCloseForceOpen && (
                  <button
                    ...
                    className="w-7 h-7 rounded-full bg-zinc-100 hover:bg-zinc-200 active:scale-95 text-zinc-400 hover:text-zinc-700 flex items-center justify-center cursor-pointer transition"
                  >
              ...
              <div className="pt-2 flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="px-3.5 py-1.5 bg-zinc-900 hover:bg-black active:scale-95 text-white rounded-xl text-xs font-bold transition cursor-pointer shadow-xs"
                >
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 bg-zinc-100 hover:bg-zinc-200 active:scale-95 text-zinc-800 rounded-xl text-xs font-semibold transition cursor-pointer border border-zinc-200"
                >
                ...
                <button
                  ...
                  className="p-1.5 text-zinc-500 hover:text-zinc-800 hover:bg-zinc-100 rounded-lg transition cursor-pointer"
      ...
      {showPreferences && (
        ...
        >
          <div
            className="bg-white border border-zinc-200/90 rounded-t-3xl sm:rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-in slide-in-from-bottom-6 sm:zoom-in-95 duration-200"
          ...
          >
            ...
            <div className="px-5 sm:px-6 py-4 space-y-3.5 text-xs text-zinc-600">
              {/* Essential Storage */}
              <div className="p-3.5 bg-zinc-50/80 rounded-2xl border border-zinc-200/80 space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-zinc-900 text-xs sm:text-sm">
                    {isEn ? "1. Essential Local Storage" : "1. Mahalagang Local Storage"}
                  </span>
                  <span className="text-[10px] font-bold bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded-full border border-emerald-200/50">
            ...
            <div className="px-5 sm:px-6 py-3.5 border-t border-zinc-100 bg-zinc-50/95 backdrop-blur-md flex items-center justify-end gap-2 sticky bottom-0 z-10">
              <button
                type="button"
                onClick={() => handleSave(analyticsAllowed ? "all" : "essential")}
                className="px-5 py-2 bg-zinc-900 hover:bg-black active:scale-95 text-white text-xs font-bold rounded-xl transition cursor-pointer flex items-center gap-1.5 shadow-xs"
              >

      ...
      <footer className="mt-12 border-t border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-zinc-950 py-8 text-center text-xs text-zinc-500 dark:text-zinc-400 transition-colors duration-200">
        <div className="max-w-6xl mx-auto px-4 space-y-3">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-2">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-900 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 hover:border-emerald-200 dark:hover:border-emerald-800 border border-zinc-200/80 dark:border-zinc-800 text-xs font-semibold text-zinc-800 dark:text-zinc-200 transition shadow-2xs">
